...
|-------|----------|------------|
| `--bg-0 / --bg-1 / --bg-2` | `#141b2d / #1a233a / #1e293b` | Глубокий мягкий сине-серый шёлковый фон |
| `--accent / --accent-strong` | `#00b4d8 / #00a8e8` | Неоново-голубые акценты, кнопки, рамки |
| `--accent-deeper / --accent-soft` | `#0077b6 / #8ee9f9` | Глубина градиентов, мягкая бирюза |
| `--text / --text-soft / --text-mute` | `#e9f1fb / #b7c5dd / #8291b0` | Приглушённый, легко читаемый текст |
